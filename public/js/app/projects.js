...
exports.UPDATE_USER = exports.FETCH_PROJECTS = undefined;
...
var _actionsUser = __webpack_require__(118);
...
var userAction = __webpack_require__(118);
...
function fetchProjects(user_id) {
	...
	var request = _axios2.default.get("/api/projects/by_user/" + user_id);
...
var _fluxStandardAction = __webpack_require__(223);
...
var _lodashIsplainobject = __webpack_require__(224);
...
var _reduxPromise = __webpack_require__(222);
...
var _projectContainer = __webpack_require__(342);
...
console.log(_projectContainer2.default);
_reactDom2.default.render(_react2.default.createElement(
  _reactRedux.Provider,
  { store: createStoreWithMiddleware(_reducers2.default) },
  _react2.default.createElement(_projectContainer2.default, null)
...
var _reducer_projects = __webpack_require__(341);

var _reducer_projects2 = _interopRequireDefault(_reducer_projects);

var _reducer_user = __webpack_require__(254);
...
var _projectsView = __webpack_require__(343);

var _projectsView2 = _interopRequireDefault(_projectsView);

var _projectsCreator = __webpack_require__(344);

var _projectsCreator2 = _interopRequireDefault(_projectsCreator);
...
console.log(_projectsView2.default);
...
var ProjectContainer = function (_Component) {
	...
	_createClass(ProjectContainer, [{
		...
		value: function componentWillMount() {
			...
			var user;
			_axios2.default.get('/users/whoami').then(function (response) {
				user = response.data;
				_this2.props.updateUser(user);
				_this2.props.fetchProjects(user.id);
			});
		}
	}, {
		key: 'render',
		value: function render() {
			if (this.state.view == VIEW) {
				return _react2.default.createElement(_projectsView2.default, {
					projects: this.props.projects,
					createClicked: this.createClicked });
			} else {
				return _react2.default.createElement(_projectsCreator2.default, { cancel: this.cancelCreation });
			}
			// if (!this.props.user) {
...
function mapDispatchToProps(dispatch) {
	return (0, _redux.bindActionCreators)({ fetchProjects: _actions.fetchProjects, updateUser: _actions.updateUser }, dispatch);
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ProjectContainer);
...
function ProjectsView(props) {
				...
				_react2.default.createElement(
					"div",
					{
						onClick: function onClick() {
							window.location = "/editor/" + project.project_id;
						},
	...
	return _react2.default.createElement(
		"div",
		{ className: "projects-viewer" },
		_react2.default.createElement(
			"div",
			{ className: "action-bar" },
			_react2.default.createElement(
				"span",
				{ className: "create-action", onClick: props.createClicked },
				_react2.default.createElement("i", { className: "fa fa-plus fa-2x center primary-text", "aria-hidden": "true" })
			)
		),
		_react2.default.createElement(
			"div",
...
var ProjectsCreator = function (_Component) {
	_inherits(ProjectsCreator, _Component);

	function ProjectsCreator(props) {
		_classCallCheck(this, ProjectsCreator);

		var _this = _possibleConstructorReturn(this, (ProjectsCreator.__proto__ || Object.getPrototypeOf(ProjectsCreator)).call(this, props));
	...
	_createClass(ProjectsCreator, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'form',
				{ className: 'form-horizontal form-creator well bs-component', onSubmit: this.onSubmit },
				_react2.default.createElement(
					'fieldset',
					null,
					_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'form-group', style: { paddingLeft: 20 + "px" } },
						_react2.default.createElement(
							'button',
						...
						_react2.default.createElement(
							'button',
							{ type: 'button', className: 'btn btn-default', onClick: this.props.cancel },
							'Cancel'
						)
					)
				)
...
exports.default = ProjectsCreator;
...
// module
exports.push([module.i, ".primary-text {\n  color: #ffffff; }\n\n.secondary-text {\n  color: #000000; }\n\n.form-creator {\n  margin: 30px; }\n\n.action-bar {\n  height: 60px;\n  width: 100%; }\n\n.action-bar .create-action {\n  float: right;\n  height: 60px;\n  width: 60px;\n  background: green;\n  border-radius: 50%;\n  cursor: pointer; }\n\n.projects-viewer {\n  margin: 30px; }\n\n.owner-divider {\n  font-size: 2em;\n  border-bottom-color: grey;\n  border-bottom-style: solid;\n  border-bottom-width: 2px;\n  border-bottom-left-radius: 2px;\n  border-bottom-right-radius: 2px;\n  margin-bottom: 3px;\n  padding-left: 4px;\n  padding-right: 4px; }\n\n.center {\n  transform: translate(20px, 20px); }\n\n.project-view {\n  text-align: center;\n  color: #ffffff;\n  background-color: #b71c1c;\n  height: 50px;\n  font-size: 2em;\n  border-radius: 4px;\n  margin-bottom: 10px;\n  cursor: pointer; }\n", ""]);
